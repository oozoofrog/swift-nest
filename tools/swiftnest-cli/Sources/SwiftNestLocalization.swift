...
enum SwiftNestLocalizer {
    ...
    private static let localizedTemplates: [SwiftNestLanguage: [SwiftNestMessageKey: String]] = [
        .en: [
            ...
            .onboardingNextStepCodexSkillsNeeded: "- If you use Codex, run %@ to install the repo-local Codex skill environment under .agents/skills.",
        ...
        .ko: [
            ...
            .onboardingNextStepCodexSkillsNeeded: "- Codex를 사용한다면 %@ 명령으로 .agents/skills 아래에 repo-local Codex 스킬 환경을 설치하세요.",
