...
final class SwiftNestCLITests: XCTestCase {
    ...
    func testOnboardWithCodexSkillAgentCreatesRepoLocalAgentSkills() throws {
        ...
        let bundledSkillURL = targetRoot.appendingPathComponent(".agents/skills/swift-master/SKILL.md")
        let bundledReferenceURL = targetRoot.appendingPathComponent(".agents/skills/swift-master/references/quick-reference.md")
        XCTAssertTrue(fileManager.fileExists(atPath: bundledSkillURL.path))
        XCTAssertTrue(fileManager.fileExists(atPath: bundledReferenceURL.path))
        ...
        let bundledSkillText = try String(contentsOf: bundledSkillURL, encoding: .utf8)
        XCTAssertTrue(bundledSkillText.contains("name: swift-master"))
        XCTAssertTrue(bundledSkillText.contains("Swift/iOS 코드베이스를 리뷰"))
    ...
    private func makeRepositoryFixture(
        ...
        let directoryPaths = [
            ...
            "resources/agents/codex/bundled-skills",
        ...
        var filePaths = [
            ...
            "resources/agents/codex/bundled-skills/swift-master/SKILL.md",
            "resources/agents/codex/bundled-skills/swift-master/agents/openai.yaml",
            "resources/agents/codex/bundled-skills/swift-master/references/quick-reference.md",
        ...
        let fileContents: [String: String] = [
            ...
            ---
            name: swift-master
            description: Review and optimize Swift/iOS code.
            ---

            Swift/iOS 코드베이스를 리뷰, 최적화, 마이그레이션, 가이드, 생성할 때 사용하는 통합 스킬.
            """,
            "resources/agents/codex/bundled-skills/swift-master/agents/openai.yaml": """
            display_name: Swift Master
            short_description: Swift expert skill
            default_prompt: Review this Swift code.
            """,
            "resources/agents/codex/bundled-skills/swift-master/references/quick-reference.md": """
            Quick reference for swift-master.
            """,
